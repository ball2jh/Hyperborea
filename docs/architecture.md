...
flowchart LR
    ...
    WifiAdapter -. "binds as @IntoSet" .-> BroadcastAdapter
...
flowchart LR
    ...
    Orchestrator -- "Flow&lt;ExerciseData&gt;" --> WIFI["WifiAdapter\n:broadcast:wifi"]
    FTMS -- "BLE GATT" --> Zwift
    WIFI -- "TCP" --> Apps["Fitness Apps"]
