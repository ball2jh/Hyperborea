...
Hyperborea is an Android app that bridges a NordicTrack S22i stationary bike to Zwift and other fitness platforms via BLE and WiFi. It reads bike data through the FitPro protocol over USB serial and rebroadcasts it as standard fitness protocols (BLE FTMS and Wahoo WFTNP).
